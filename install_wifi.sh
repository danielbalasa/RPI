...
# install-wifi - 26/04/2020 - by MrEngman.
...
display_help() {
	...
	echo "#			 driver - specific driver to check for, one of: 8188eu, 8188fu, 8192eu, 8812au, 8822bu, mt7610 or mt7612"
	...
	echo "#			 driver - specific driver to update/install, one of: 8188eu, 8188fu, 8192eu, 8812au, 8822bu, mt7610 or mt7612"
	...
	echo "#			 driver - specific driver to install, one of: 8188eu, 8188fu, 8192eu, 8812au, 8822bu, mt7610 or mt7612"
	echo "#	[option]:- 	  blank - update/install driver for currently running kernel"
	echo "#		     rpi-update - update/install driver for latest version of rpi-update"
	echo "#		      commit-id - update/install driver for specific commit-id of rpi-update"
	echo "#"
...
fetch_driver() {
	...
	elif cat .lsusb | grep -i '13B1:0043\|2001:331E\|0846:9055\|0E66:0025\|2357:012D\|2357:0115\|2001:331C\|7392:C822\|0B05:184C\|7392:B822\|0B05:1812\|0BDA:B812\|0BDA:B82C' ; then
		driver=8822bu
	...
	if [[ ! $driver ]] ; then
		...
		echo
		echo "The script only works for wifi modules using the rtl8188eu, rtl8188fu, rtl8192eu, rtl8812au, 8822bu, mt7610 and mt7612 drivers."
		echo
